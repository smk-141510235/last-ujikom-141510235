        ...
        <div class="container">
            <div class="row">
             <center><h2>Data Kategori Pegawai</h2></center>
                <div class="section">
<center><form action="<?php echo e(url('Kategori')); ?>/?Kode_lembur=Kode_lembur">
...
<br>
 ...
 &nbsp;&nbsp;&nbsp;<a href="<?php echo e(url('Kategori/create')); ?>" class="btn btn-primary">Input Data Kategori&nbsp;&nbsp;&nbsp;<i class="fa fa-pencil"></i></a>
            <div class="row">
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <td><center><a href="<?php echo e(url('Kategori', $data->id)); ?>" class="btn btn-primary">Lihat</a></center></td>
            <td><center><a href="<?php echo e(route('Kategori.edit', $data->id)); ?>" class="btn btn-warning">Ubah</a></center></td>
                                 <th>
